...
class MAG240M(LightningDataModule):
    ...
    def prepare_data(self):
        ...
        if not osp.exists(done_flag_path):  # Will take ~3 hours...
            ...
            x = np.empty((N, self.num_features), dtype=np.float16)
...
if __name__ == '__main__':
    ...
    if not args.evaluate:
        ...
        trainer = Trainer(gpus=args.device, max_epochs=args.epochs,
                          ...
                          default_root_dir=f'logs/{args.model}', accelerator='gpu', devices=1)
    ...
    if args.evaluate:
        ...
        trainer = Trainer(gpus=args.device, resume_from_checkpoint=ckpt, accelerator='gpu', devices=1)
